	...
	public class CFHTTPMessage : CFType, INativeObject, IDisposable {
		...
		static CFHTTPMessage ()
		{
			...
			try {
				...
				_AuthenticationSchemeBasic = GetStringConstant (handle, "kCFHTTPAuthenticationSchemeBasic");
				_AuthenticationSchemeNegotiate = GetStringConstant (handle, "kCFHTTPAuthenticationSchemeNegotiate");
				_AuthenticationSchemeNTLM = GetStringConstant (handle, "kCFHTTPAuthenticationSchemeNTLM");
				_AuthenticationSchemeDigest = GetStringConstant (handle, "kCFHTTPAuthenticationSchemeDigest");

				_AuthenticationUsername = GetStringConstant (handle, "kCFHTTPAuthenticationUsername");
				_AuthenticationPassword = GetStringConstant (handle, "kCFHTTPAuthenticationPassword");
				_AuthenticationAccountDomain = GetStringConstant (handle, "kCFHTTPAuthenticationAccountDomain");
			} finally {
		...
		[DllImport (Constants.CFNetworkLibrary)]
		extern static bool CFHTTPMessageApplyCredentials (IntPtr request, IntPtr auth, IntPtr user, IntPtr pass, out CFStreamError error);
		...
		[DllImport (Constants.CFNetworkLibrary)]
		extern static bool CFHTTPMessageAddAuthentication (IntPtr request, IntPtr response, IntPtr username, IntPtr password, IntPtr scheme, bool forProxy);
		...
		[DllImport (Constants.CFNetworkLibrary)]
		extern static bool CFHTTPMessageApplyCredentialDictionary (IntPtr request, IntPtr auth, IntPtr dict, out CFStreamError error);
		...
		[DllImport (Constants.CFNetworkLibrary)]
		extern static void CFHTTPMessageSetHeaderFieldValue (IntPtr message, IntPtr headerField, IntPtr value);
